...
INSERT INTO products
  (price, title,                 description,                                                                                                                                                                category_id, upload_id, in_stock) VALUES
  (12.99, 'Carrot Seeds',        'High-yield early variety that produces crisp, sweet roots ideal for salads, juicing, and cooking. Thrives in loose soil and requires moderate sunlight for best results.', 1,           9,         TRUE),
  ...
  (7.99,  'Clay Pot 20cm',       'Durable clay pot for small plants, offering natural breathability and moisture control. Great for herbs, flowers, and decorative indoor arrangements.',                    3,           8,         TRUE),
  ...
  (11.20, 'Basil Seeds',         'Aromatic herb for cooking, ideal for fresh use or drying. Grows well in pots or garden beds and enhances dishes with its distinct, flavorful fragrance.',                  1,           13,        TRUE),
  (8.60,  'Hand Rake',           'Compact rake for flower beds, ideal for loosening soil and removing debris. Features ergonomic grip for comfortable handling and efficient garden tidying.',               2,           1,         TRUE),
  (6.49,  'Plastic Pot 15cm',    'Lightweight and durable, suitable for indoor or outdoor use. Resistant to weather and perfect for herbs, succulents, or decorative small flowering plants.',               3,           4,         TRUE),
  (22.00, 'Cactus Mix Soil',     'Ideal for succulents and cacti, this mix offers excellent drainage and aeration. Enriched with minerals to promote strong root systems and healthy growth.',               4,           10,        TRUE),
  ...
  (25.5,  'Sunflower Seeds',     'High-quality seeds for home gardening, yielding tall, bright sunflowers. Great for pollinators, cut flower arrangements, and producing edible seeds.',                     1,           3,         TRUE),
  ...
  (23.76, 'Box Tree',            'Excellent choice for landscaping, offering dense foliage and easy shaping. Perfect for hedges, topiary, or standalone ornamental features in gardens.',                    9,           11,        TRUE),
  (26.01, 'Lettuce Seeds',       'High-quality seeds for home gardening that produce tender, crisp leaves. Suitable for container or ground planting with rapid germination and harvest.',                   1,           5,         TRUE),
  (17.41, 'Hydrangea',           'Adds a decorative touch to any space with large, colorful blooms. Prefers moist, well-drained soil and provides lasting beauty throughout the growing season.',            5,           6,         TRUE),
  (10.73, 'Lettuce Seeds',       'High-quality seeds for home gardening that are reliable and fast-growing. Produce tasty, fresh leaves that are perfect for salads and healthy meals.',                     1,           5,         TRUE),
  ...
  (18.45, 'Tomato Seeds',        'Ensures high germination and strong plants with juicy, flavorful fruit. Suitable for pots or garden beds and offers excellent resistance to common diseases.',             1,           2   ,      TRUE),
  ...
  (19.75, 'Terracotta Pot',      'Stylish and durable plant pot that provides excellent root ventilation. Classic design enhances any plant display, indoors or on a garden patio.',                         3,           8,         TRUE),
  ...
  (12.95, 'Bone Meal',           'Balanced nutrients for all plant types, rich in phosphorus and calcium. Encourages strong root growth and flowering, ideal for bulbs and perennials.',                     6,           12,        TRUE),
  ...
  (16.75, 'Sunflower Seeds',     'Perfect for beginners and experienced gardeners seeking bright, tall blooms. These seeds grow into stunning sunflowers that attract birds and bees.',                      1,           3,         TRUE),
  ...
  (14.30, 'Hanging Basket',      'Perfect for indoor and outdoor use, this basket enhances vertical space. Ideal for trailing plants and herbs with a strong frame and attractive design.',                  3,           7,         TRUE),
  ...
  (13.75, 'Basil Seeds',         'High-quality seeds for home gardening that grow into aromatic herbs. Great for culinary use, container growing, and attracting pollinators.',                              1,           13,        TRUE),
  (28.99, 'Hand Rake',           'Designed for comfortable use during long hours in the garden. Helps break up soil, remove debris, and maintain beds with ease and precision.',                             2,           1,         TRUE);
