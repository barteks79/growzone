...
INSERT INTO orders (order_id, order_date, status, shipping_address_id, delivery_date, user_id) VALUES
   (1, CURDATE(), 'wyslano', 1, NULL, 1),
   (2, CURDATE(), 'wyslano', 2, NULL, 2),
   (3, CURDATE(), 'dostarczono', 3, CURDATE(), 3),
   (4, CURDATE(), 'dostarczono', 4, DATE_ADD(CURDATE(), INTERVAL 4 DAY), 4),
   (5, CURDATE(), 'wyslano', 5, NULL, 5),
   (6, CURDATE(), 'wyslano', 6, NULL, 6),
   (7, CURDATE(), 'dostarczono', 7, CURDATE(), 7),
   (8, CURDATE(), 'wyslano', 8, NULL, 8),
   (9, CURDATE(), 'dostarczono', 9, DATE_ADD(CURDATE(), INTERVAL 1 DAY), 9),
   (10, CURDATE(), 'dostarczono', 10, CURDATE(), 10),
   (11, CURDATE(), 'wyslano', 11, NULL, 11),
   (12, CURDATE(), 'wyslano', 12, NULL, 12),
   (13, CURDATE(), 'dostarczono', 13, CURDATE(), 13),
   (14, CURDATE(), 'dostarczono', 14, DATE_ADD(CURDATE(), INTERVAL 1 DAY), 14),
   (15, CURDATE(), 'wyslano', 15, NULL, 15),
   (16, CURDATE(), 'dostarczono', 16, CURDATE(), 16),
   (17, CURDATE(), 'wyslano', 17, NULL, 17),
   (18, CURDATE(), 'wyslano', 18, NULL, 18),
   (19, CURDATE(), 'dostarczono', 19, CURDATE(), 19),
   (20, CURDATE(), 'dostarczono', 20, DATE_ADD(CURDATE(), INTERVAL 1 DAY), 20);
