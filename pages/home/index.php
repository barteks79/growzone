                ...
                <?php if ($user): ?>
                    <div class="relative group">
                        <button class="size-10 cursor-pointer relative">
                            <span class="avatar bg-neutral-300 font-bold text-white size-full rounded-full grid place-items-center" data-first-name="<?= htmlspecialchars($user['first_name']) ?>" data-last-name="<?= htmlspecialchars($user['last_name']) ?>"></span>
                        ...
                        <div class="absolute z-[2] -right-4 invisible group-hover:visible min-w-[15rem]">
                            ...
                            <div class="group-hover:scale-y-100 group-hover:opacity-100 opacity-50 scale-y-0 origin-top transition grid px-2 py-4 rounded-md bg-white shadow-md">
                                <div class="flex items-center gap-2 px-4">
                                    <span class="avatar bg-neutral-300 text-white font-bold rounded-full size-9 grid place-items-center" data-first-name="<?= htmlspecialchars($user['first_name']) ?>" data-last-name="<?= htmlspecialchars($user['last_name']) ?>"></span>
