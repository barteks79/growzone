...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const isCityEntered = () => document.querySelector('[name="miasto"]')?.value !== '';

    const isStreetEntered = () => document.querySelector('[name="ulica"]')?.value !== '';
    ...
    nextPageBtnDostawa?.addEventListener('click', async e => {
        if (
            ...
            const eneteredPostalCode = document.querySelector('[name="kod_pocztowy"]').value;
            const enetredBuilding = document.querySelector('[name="budynek"]').value;
            const eneteredApartment = document.querySelector('[name="apartament"]').value;
